<?php
/**
 * @version   2.50.8 November 14, 2015
...
Description: RokBox 2.50.8 is a fully responsive modal plug-in for WordPress and the successor of RokBox1. Rewritten from the ground up it can display many different media formats such as images, videos, music, embedded widgets, Ajax content and WordPress widgets and takes advantage of the new technologies such as HTML5 and CSS3.
...
class RokBox {
	...
	function _register_hooks() {
		 ...
		 * MooTools Init
		 */
		add_action( 'wp_enqueue_scripts', array( &$this, 'enqueue_mootools' ));
